...
Intensity_40 = zeros(1,4); % Intensity of individual borders 0-40° in all embryos
...
n40=0; % Number of individual borders 0-40° in all embryos
...
for g=1:numel(files_tif)
    ...
    Intensity_average(g,2) = Intensity40;
    Intensity_average(g,3) = Intensity90;

    Intensity_average(g,4) = Intensity40_BG;
    Intensity_average(g,5) = Intensity90_BG;
    Intensity_average(g,6) = BG;
...
Intensity_angle = [Intensity_40 Intensity_90];
%Removing extra 0s
...
headers2 = {'0-45angels', 'Intensity', 'Intensity+BG', 'Length', '45-90angels', 'Intensity', 'Intensity+BG', 'Length'};
csvwrite_with_headers('Intensity_angles_halves.csv',Intensity_angle2, headers2);

%Averaged intensity by angle in individual embryos
headers = {'Embryo', '0-45-BG', '45-90-BG', '0-45+BG', '45-90+BG', 'BG'};
csvwrite_with_headers('Intensity_embryo_halves.csv',Intensity_average, headers);
